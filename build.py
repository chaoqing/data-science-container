...
def arg_parser():
    ...
    parser.add_argument("--desktop", help="Enable Desktop", default="none", const="openbox", nargs="?", choices=["none", "openbox", "xfce4"])
    return parser.parse_args()

def create_dockerfile(base_image, template_file, **kwargs):
